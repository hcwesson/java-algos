...
public class QuickSortM3Tester {
	...
	public static void main(String[] args) {
		int[] arr = {1,2,3,4};
		QuickSortM3.quickSort(arr); //Pre-loading the QuickSortM3 class
	...
	public static void test16() {
		...
		QuickSortM3.quickSort(elems);
		long stop = System.nanoTime();
		long time = stop - start;
		
		if (verbose) {
			System.out.println("16 elements quicksorted (Mo3) in " + time + " nanoseconds.");
		}
		else {
	...
	public static void test32() {
		...
		long time = stop - start;
		if (verbose) {
			System.out.println("32 elements quicksorted (Mo3) in " + time + " nanoseconds.");
		}
		else {
			System.out.println(time);
		}
	...
	public static void test64() {
		...
		long time = stop - start;
		if (verbose) {
			System.out.println("64 elements quicksorted (Mo3) in " + time + " nanoseconds.");
		}
		else {
			System.out.println(time);
		}
	...
	public static void test128() {
		...
		long time = stop - start;
		if (verbose) {
			System.out.println("128 elements quicksorted (Mo3) in " + time + " nanoseconds.");
		}
		else {
			System.out.println(time);
		}
	...
	public static void test256() {
		...
		long time = stop - start;
		if (verbose) {
			System.out.println("256 elements quicksorted (Mo3) in " + time + " nanoseconds.");
		}
		else {
			System.out.println(time);
		}
	...
	public static void test512() {
		...
		long time = stop - start;
		if (verbose) {
			System.out.println("512 elements quicksorted (Mo3) in " + time + " nanoseconds.");
		}
		else {
			System.out.println(time);
		}
	...
	public static void test1024() {
		...
		long time = stop - start;
		if (verbose) {
			System.out.println("1024 elements quicksorted (Mo3) in " + time + " nanoseconds.");
		}
		else {
			System.out.println(time);
		}
	...
	public static void test2048() {
		...
		long time = stop - start;
		if (verbose) {
			System.out.println("2048 elements quicksorted (Mo3) in " + time + " nanoseconds.");
		}
		else {
			System.out.println(time);
		}
	...
	public static void test4096() {
		...
		long time = stop - start;
		if (verbose) {
			System.out.println("4096 elements quicksorted (Mo3) in " + time + " nanoseconds.");
		}
		else {
			System.out.println(time);
		}
	...
	public static void test8192() {
		...
		long time = stop - start;
		if (verbose) {
			System.out.println("8192 elements quicksorted (Mo3) in " + time + " nanoseconds.");
		}
		else {
			System.out.println(time);
		}
	...
	public static void testRandom() {
		...
		long time = stop - start;
		if (verbose) {
			System.out.println("1024 random elements quicksorted (Mo3) in " + time + " nanoseconds.");
		}
		else {
			System.out.println(time);
		}
	...
	public static void testSorted() {
		...
		long time = stop - start;
		if (verbose) {
			System.out.println("1024 sorted ascending elements quicksorted (Mo3) in " + time + " nanoseconds.");
		}
		else {
			System.out.println(time);
		}
	...
	public static void testReverseSorted() {
		...
		long time = stop - start;
		if (verbose) {
			System.out.println("1024 sorted descending elements quicksorted (Mo3) in " + time + " nanoseconds.");
		}
		else {
			System.out.println(time);
		}
